...
export function NavPill() {
  ...
  return (
    ...
    >
      <a
        className="transition-background absolute left-1/2 top-0 z-20 flex h-14 -translate-x-1/2 transform flex-row items-center gap-2 whitespace-nowrap rounded-full border border-light11/20 bg-black bg-light1/70 bg-opacity-20 px-4 py-2 text-lg font-semibold text-light12 bg-blend-luminosity shadow-sm backdrop-blur-xl transition duration-200 ease-in-out dark:border-dark11/20 dark:bg-dark1/50 dark:text-dark12"
        href="/changelog"
      >
